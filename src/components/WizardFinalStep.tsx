...
export function WizardFinalStep({ data, onSubmit, isSubmitting }: WizardFinalStepProps) {
  ...
  const getSkillHighlights = () => {
    ...
    data.skills.forEach(skill => {
      ...
      categories[level].push(skill.name);
    });
          ...
          <CardContent className="p-6">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
              ...
              <div className="text-center">
                ...
                <div className="text-xs text-muted-foreground mt-1">
                  {stats.experiences === 0 ? "Mínimo 1" : "Perfecto"}
                </div>
              </div>
              ...
              <div className="text-center">
                ...
                <div className="text-xs text-muted-foreground mt-1">
                  {stats.education === 0 ? "Opcional" : "Agregado"}
                </div>
              </div>
              ...
              <div className="text-center">
                ...
                <div className="text-xs text-muted-foreground mt-1">
                  {stats.certifications === 0 ? "Recomendado" : "¡Genial!"}
                </div>
              </div>
            </div>
          </CardContent>
            ...
            {data.skills && data.skills.length > 0 && (
              <div className="mb-6">
                ...
                <div className="space-y-3">
                  {Object.entries(skillCategories).map(([level, skills]) => {
                      ...
                      <div key={level} className="bg-gray-50 p-4 rounded-xl">
                        ...
                        <div className="flex flex-wrap gap-2">
                          {skills.slice(0, 8).map((skill, index) => (
                            <Badge 
                              key={index} 
                              className={`${levelData[level]?.color} border`}
                            >
                              {skill}
                            </Badge>
                          ))}
        ...
        <Card className="bg-gradient-to-r from-purple-600 via-pink-600 to-blue-600 text-white shadow-2xl border-0">
          <CardContent className="p-8">
            ...
            <p className="text-white/90 mb-6 max-w-2xl mx-auto">
              Tu perfil profesional será visible para Project Managers y Tech Leads de Axity. 
              Te conectaremos con proyectos que se alineen perfectamente con tu experiencia y objetivos.
            </p>
        ...
        <Card className="bg-gray-50 border-gray-200">
          <CardContent className="p-4">
            <p className="text-xs text-muted-foreground leading-relaxed">
              Al actualizar tu perfil, confirmas que la información es veraz y actual. 
              Este perfil se utiliza exclusivamente para asignación de proyectos y desarrollo 
              profesional dentro de Axity, siguiendo nuestras políticas de privacidad y seguridad.
            </p>
          </CardContent>
        </Card>
      </motion.div>
